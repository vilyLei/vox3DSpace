...
namespace std {
	...
	template <> struct is_floating_point<baseMath::half> : public std::true_type
{};	  	

	template<>
	class numeric_limits< baseMath::half> {
	public:
		typedef baseMath::half type;
		...
		inline static constexpr type round_error() noexcept { return baseMath::makeHalf(0x3800); }
		inline static constexpr type _min() noexcept { return baseMath::makeHalf(0x0400); }
		inline static constexpr type _max() noexcept { return baseMath::makeHalf(0x7bff); }
		inline static constexpr type lowest() noexcept { return baseMath::makeHalf(0xfbff); }
		inline static constexpr type epsilon() noexcept { return baseMath::makeHalf(0x1400); }
		inline static constexpr type infinity() noexcept { return baseMath::makeHalf(0x7c00); }
		inline static constexpr type quiet_NaN() noexcept { return baseMath::makeHalf(0x7fff); }
		inline static constexpr type denorm_min() noexcept { return baseMath::makeHalf(0x0001); }
		inline static constexpr type signaling_NaN() noexcept { return baseMath::makeHalf(0x7dff); }
	};
