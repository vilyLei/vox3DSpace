...
private:
    ...
    void init() {
        ...
        createInstance();
        window_ = std::make_unique<Window>(700, 700, "Archimedean Spiral");
        ...
        if (std::filesystem::exists("Release/scripts/test_vis_spiral"))
            scriptDir = "Release/scripts/test_vis_spiral/";
        else if (std::filesystem::exists("Debug/scripts/test_vis_spiral"))
            scriptDir = "Debug/scripts/test_vis_spiral/";
        else
            scriptDir = "scripts/test_vis_spiral/";
        ...
        createSyncObjects();
        std::cout << "Init OK: 8 objects created." << std::endl;
    ...
    void createInstance() {
        vk::ApplicationInfo ai{}; ai.pApplicationName="test_vis_spiral"; ai.apiVersion=VK_API_VERSION_1_0;
...
int main() {
    std::cout << "=== TEST: test_vis_spiral ===" << std::endl;
    std::cout << "Purpose: Verify r=a*theta, mod wrap, cos/sin compound" << std::endl;
    try { Test_test_vis_spiral test; test.run(); return 0; }
