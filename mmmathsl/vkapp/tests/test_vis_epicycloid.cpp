...
class Test_test_vis_epicycloid {
public:
...
private:
    ...
    void init() {
        ...
        createInstance();
        window_ = std::make_unique<Window>(700, 700, "Epicycloid (k=2,3,5)");
        ...
        if (std::filesystem::exists("Release/scripts/test_vis_epicycloid"))
            scriptDir = "Release/scripts/test_vis_epicycloid/";
        else if (std::filesystem::exists("Debug/scripts/test_vis_epicycloid"))
            scriptDir = "Debug/scripts/test_vis_epicycloid/";
        else
            scriptDir = "scripts/test_vis_epicycloid/";
    ...
    void createInstance() {
        vk::ApplicationInfo ai{}; ai.pApplicationName="test_vis_epicycloid"; ai.apiVersion=VK_API_VERSION_1_0;
...
int main() {
    std::cout << "=== TEST: test_vis_epicycloid ===" << std::endl;
    std::cout << "Purpose: Verify nested trig: (R+r)*cos(t)-r*cos(ratio*t)" << std::endl;
    try { Test_test_vis_epicycloid test; test.run(); return 0; }
