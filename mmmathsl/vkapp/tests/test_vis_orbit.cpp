...
private:
    ...
    void init() {
        ...
        createInstance();
        window_ = std::make_unique<Window>(700, 700, "Orbital System");
        ...
        if (std::filesystem::exists("Release/scripts/test_vis_orbit"))
            scriptDir = "Release/scripts/test_vis_orbit/";
        else if (std::filesystem::exists("Debug/scripts/test_vis_orbit"))
            scriptDir = "Debug/scripts/test_vis_orbit/";
        else
            scriptDir = "scripts/test_vis_orbit/";
    ...
    void createInstance() {
        vk::ApplicationInfo ai{}; ai.pApplicationName="test_vis_orbit"; ai.apiVersion=VK_API_VERSION_1_0;
...
int main() {
    std::cout << "=== TEST: test_vis_orbit ===" << std::endl;
    std::cout << "Purpose: Verify star+moon orbital mechanics with all 4 channels" << std::endl;
    try { Test_test_vis_orbit test; test.run(); return 0; }
