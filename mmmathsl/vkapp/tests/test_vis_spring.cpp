...
private:
    ...
    void init() {
        ...
        createInstance();
        window_ = std::make_unique<Window>(600, 700, "Damped Oscillator");
        ...
        if (std::filesystem::exists("Release/scripts/test_vis_spring"))
            scriptDir = "Release/scripts/test_vis_spring/";
        else if (std::filesystem::exists("Debug/scripts/test_vis_spring"))
            scriptDir = "Debug/scripts/test_vis_spring/";
        else
            scriptDir = "scripts/test_vis_spring/";
    ...
    void createInstance() {
        vk::ApplicationInfo ai{}; ai.pApplicationName="test_vis_spring"; ai.apiVersion=VK_API_VERSION_1_0;
...
int main() {
    std::cout << "=== TEST: test_vis_spring ===" << std::endl;
    std::cout << "Purpose: Verify exp(-b*t)*cos(w*t) damped oscillation" << std::endl;
    try { Test_test_vis_spring test; test.run(); return 0; }
