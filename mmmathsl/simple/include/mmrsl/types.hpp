...
struct Mat2 {
    ...
    Mat2(const Vec2& col0, const Vec2& col1) : columns{col0, col1} {}
    Mat2(float m00, float m01, float m10, float m11) 
        : columns{Vec2(m00, m01), Vec2(m10, m11)} {}
    
    Vec2& operator[](size_t col) { return columns[col]; }
    const Vec2& operator[](size_t col) const { return columns[col]; }
    
    float& operator()(size_t col, size_t row) { return columns[col][row]; }
    const float& operator()(size_t col, size_t row) const { return columns[col][row]; }
...
struct Mat3 {
    ...
    Vec3& operator[](size_t col) { return columns[col]; }
    const Vec3& operator[](size_t col) const { return columns[col]; }
...
struct Mat4 {
    ...
    Mat4() : columns{Vec4(1,0,0,0), Vec4(0,1,0,0), Vec4(0,0,1,0), Vec4(0,0,0,1)} {}
    ...
    Vec4& operator[](size_t col) { return columns[col]; }
    const Vec4& operator[](size_t col) const { return columns[col]; }
...
public:
    ...
    Value() = default;
    explicit Value(int v) : data_(v), kind_(TypeKind::Int) {}
    explicit Value(float v) : data_(v), kind_(TypeKind::Float) {}
    explicit Value(bool v) : data_(v), kind_(TypeKind::Bool) {}
    explicit Value(const Vec2& v) : data_(v), kind_(TypeKind::Vec2) {}
    explicit Value(const Vec3& v) : data_(v), kind_(TypeKind::Vec3) {}
    explicit Value(const Vec4& v) : data_(v), kind_(TypeKind::Vec4) {}
    explicit Value(const Mat2& v) : data_(v), kind_(TypeKind::Mat2) {}
    explicit Value(const Mat3& v) : data_(v), kind_(TypeKind::Mat3) {}
    explicit Value(const Mat4& v) : data_(v), kind_(TypeKind::Mat4) {}
    ...
    bool isVec2() const { return kind_ == TypeKind::Vec2; }
    bool isVec3() const { return kind_ == TypeKind::Vec3; }
    bool isVec4() const { return kind_ == TypeKind::Vec4; }
    bool isMat2() const { return kind_ == TypeKind::Mat2; }
    bool isMat3() const { return kind_ == TypeKind::Mat3; }
    bool isMat4() const { return kind_ == TypeKind::Mat4; }
