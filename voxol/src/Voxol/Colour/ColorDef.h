...
struct Color
{
    ...
    constexpr uint8_t floatR() const noexcept { return ((value >> 16) & 0xFF) / 255.0f; }
    constexpr uint8_t floatG() const noexcept { return ((value >> 8) & 0xFF) / 255.0f; }
    constexpr uint8_t floatB() const noexcept { return (value & 0xFF) / 255.0f; }
