...
public:
    ...
    void traverseSortIndexWithInstance(uint32_t instanceEntityId, uint32_t prototypeId, uint32_t& index);
    ...
    void traverseBuildGlobalMatInstance(uint32_t instanceRootId, const Math::Mat33& parentMat, Component::UnitInstanceMap& insMap);
