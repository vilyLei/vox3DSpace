...
// 添加 Item
// -----------------------------
void BVH2D::addItem(int32_t objectId, const Math::Bounds& bounds)
{
    Item item{};
...
// -----------------------------
bool BVH2D::updateItemBoundsByObjectId(int32_t objectId, const Math::Bounds& newBounds)
{
...
// 点查询
// -----------------------------
void BVH2D::queryPoint(const Math::Vec2& p, std::vector<int32_t>& outIds) const
{
...
// 范围查询
// -----------------------------
void BVH2D::queryBounds(const Math::Bounds& b, std::vector<int32_t>& outIds) const
{
    if (m_nodes.empty()) return;
...
// 点查询递归
// -----------------------------
void BVH2D::queryPointRecursive(int nodeIndex, const Math::Vec2& p, std::vector<int32_t>& outIds) const
{
...
// 范围查询递归
// -----------------------------
void BVH2D::queryBoundsRecursive(int nodeIndex, const Math::Bounds& b, std::vector<int32_t>& outIds) const
{
    const Node& node = m_nodes[nodeIndex];
