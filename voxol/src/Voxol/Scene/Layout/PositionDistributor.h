...
{
public:
    static std::vector<Math::Vec2> circle(int count, const Math::Vec2& center, float radius = 50, float startRadian = 0);
    ...
    static std::vector<Math::Vec2> arc(int count, const Math::Vec2& center, float radius = 50, float startRadian = 0, float arcRadian = 3.14159f);
};
} // namespace Voxol::Scene::Layout
#endif