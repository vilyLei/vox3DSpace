...
macro(set_vox3dspace_target)
  ...
  if(MSVC)
    ...
    message("--- vox3dspace_engine_base_dependency: ${vox3dspace_engine_base_dependency}")
  else()
...
macro(vox3dspace_set_build_definitions)
  ...
  list(APPEND vox3dspace_include_paths "${vox3dspace_root}" "${vox3dspace_root}/src"
              "${vox3dspace_build}")
  list(APPEND vox3dspace_engine_base_include_paths "${vox3dspace_root}" "${vox3dspace_root}/src"
  "${vox3dspace_engine_base_build}")
  ...
  if(EMSCRIPTEN)
    vox3dspace_check_emscripten_environment()
    vox3dspace_get_required_emscripten_flags(FLAG_LIST_VAR_COMPILER
                                        vox3dspace_base_cxx_flags
                                        FLAG_LIST_VAR_LINKER
                                        vox3dspace_base_exe_linker_flags)
  endif()
