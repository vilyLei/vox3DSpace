...
void testMain()
{
    std::cout << "\nany01::testMain() begin.\n";

    std::cout << std::boolalpha;
    //std::variant<CA, int> varCA;// error, has not default constructor ...
    std::variant<std::monostate, CA, int> varCA2; // ok
    std::variant<CB, int> varCB;// ok
