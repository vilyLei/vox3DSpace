...
bool GameApp::InitEffect()
{
    ...
    auto             path_vs     = std::filesystem::path(CMAKE_CURRENT_SOURCE_DIR) / "demos/directx11_rendering/hlsl/cube_vert.hlsl";
    auto             path_vs_cso = std::filesystem::path(CMAKE_CURRENT_SOURCE_DIR) / "demos/directx11_rendering/hlsl/cube_vert.cso";
    auto             path_ps     = std::filesystem::path(CMAKE_CURRENT_SOURCE_DIR) / "demos/directx11_rendering/hlsl/cube_frag.hlsl";
    ...
    HR(CreateShaderFromFile(path_vs_cso.wstring().c_str(), path_vs.wstring().c_str(), "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    HR(CreateShaderFromFile(path_ps_cso.wstring().c_str(), path_ps.wstring().c_str(), "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
