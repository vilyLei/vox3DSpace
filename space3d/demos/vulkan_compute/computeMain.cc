...
private:
    ...
    void createInstance()
    {
        ...
        appInfo.pApplicationName   = "computeShader";
    ...
    void createGraphicsPipeline()
    {
        ...
        auto fragShaderCode = readFile(path_fragString.c_str());
    ...
    createComputePipeline()
    {
        ...
        std::cout << "path_compString: " << path_compString << std::endl;
        auto computeShaderCode = readFile(path_compString);
