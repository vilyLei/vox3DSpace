if(VOX3DSPACE_CMAKE_VOX3DSPACE_HELPERS_CMAKE_)
  return()
endif() # VOX3DSPACE_CMAKE_VOX3DSPACE_HELPERS_CMAKE_
set(VOX3DSPACE_CMAKE_VOX3DSPACE_HELPERS_CMAKE_ 1)

# Kills build generation using message(FATAL_ERROR) and outputs all data passed
# to the console via use of $ARGN.
macro(vox3dspace_die)
...
macro(vox3dspace_set_and_stringify)
  set(optional_args)
  ...
  if(NOT sas_DEST OR NOT (sas_SOURCE OR sas_SOURCE_VARS))
    vox3dspace_die("vox3dspace_set_and_stringify: DEST and at least one of SOURCE "
  ...
  if(VOX3DSPACE_VERBOSE GREATER 1)
    message("vox3dspace_set_and_stringify: ${sas_DEST}=${${sas_DEST}}")
  endif()
endmacro()

# Creates a dummy source file in $VOX3DSPACE_GENERATED_SOURCES_DIRECTORY and adds it
# to the specified target. Optionally adds its path to a list variable.
#
# vox3dspace_create_dummy_source_file(<TARGET <target> BASENAME <basename of file>>
# [LISTVAR <list variable>])
macro(vox3dspace_create_dummy_source_file)
  set(optional_args)
  ...
  if(NOT cdsf_TARGET OR NOT cdsf_BASENAME)
    vox3dspace_die("vox3dspace_create_dummy_source_file: TARGET and BASENAME required.")
  endif()

  if(NOT VOX3DSPACE_GENERATED_SOURCES_DIRECTORY)
    set(VOX3DSPACE_GENERATED_SOURCES_DIRECTORY "${vox3dspace_build}/gen_src")
  endif()

  set(dummy_source_dir "${VOX3DSPACE_GENERATED_SOURCES_DIRECTORY}")
  set(dummy_source_file
      "${dummy_source_dir}/vox3dspace_${cdsf_TARGET}_${cdsf_BASENAME}.cc")
  set(dummy_source_code
      "// Generated file. DO NOT EDIT!\n"
      "// C++ source file created for target ${cdsf_TARGET}.\n"
      "void vox3dspace_${cdsf_TARGET}_${cdsf_BASENAME}_dummy_function(void)\;\n"
      "void vox3dspace_${cdsf_TARGET}_${cdsf_BASENAME}_dummy_function(void) {}\n")
...
# $VOX3DSPACE_VERSION.
macro(vox3dspace_load_version_info)
  #cmakedev\src\voxengine\vox3dspace_version.h
  # message("--- Find version info A path: ${vox3dspace_src_root}/voxengine/vox3dspace_version.h")
  file(STRINGS "${vox3dspace_src_root}/voxengine/vox3dspace_version.h" version_file_strings)
  foreach(str ${version_file_strings})
    if(str MATCHES "char kVox3DSpaceVersion")
      # message("--- Find version info B ...")
